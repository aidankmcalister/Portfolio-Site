...
const PortfolioPageCard = ({ project }) => {
  const { img, name, lang, description } = project;
  return (
    <div className="md:h-52 bg-opacity-70 bg-slate-800 w-full  m-4 rounded-lg p-3 flex flex-col text-white max-w-lg animate-fade-up shadow-lg shadow-custom-light-blue-shadow opacity-80 font-rubik">
